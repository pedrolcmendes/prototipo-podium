...
import { useSettings, fmtHour, waLink } from '../contexts/SettingsContext';
    ...
    <footer>
      <div className="footer-top">
        <div className="footer-brand">
          ...
          <div className="footer-social">
            ...
            <a href={wa} className="soc-link" target="_blank" rel="noreferrer">
        ...
        <div className="footer-col">
          <h4>Horários</h4>
          <ul>
            <li><span style={{ fontSize: '.9rem', color: 'var(--gray)' }}>Seg a Sex: {fmtHour(settings.openWeek)} – {fmtHour(settings.closeWeek)}</span></li>
            <li><span style={{ fontSize: '.9rem', color: 'var(--gray)' }}>Sábado: {fmtHour(settings.openWeekend)} – {fmtHour(settings.closeWeekend)}</span></li>
        ...
        <div className="footer-col">
          ...
          <div className="footer-contact-item">
            ...
            <p>{settings.address.split('—')[0].trim()}<br />{(settings.address.split('—')[1] || 'Telêmaco Borba – PR').trim()}</p>
          </div>
          <div className="footer-contact-item">
            ...
            <p><a href={wa}>{settings.phone}</a></p>
          </div>
          <div className="footer-contact-item">
      ...
      <div className="footer-bottom">
        <p className="footer-copy">
          © 2026 {settings.arenaName} · {settings.address.replace('—', '·')}{settings.cnpj ? ` · CNPJ ${settings.cnpj}` : ''} &nbsp;·&nbsp;{' '}
