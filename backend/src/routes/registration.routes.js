...
const { minhasInscricoes, listar, porEvento, inscritosPublicos, inscrever, cancelar } = require('../controllers/registration.controller');
...
router.get('/evento/:eventId/publico', inscritosPublicos);
